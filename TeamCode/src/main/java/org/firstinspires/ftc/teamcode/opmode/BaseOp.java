...
public abstract class BaseOp extends LinearOpMode {
    ...
    protected StartingPosition mStartingPosition;
    protected RobotSuperDwarka robot;

    protected static Pose2d msGlobalPose = null;
    protected static StartingPosition msGlobalStartingPosition;
    ...
    protected void close() {  // Must be idempotent. Callable from ANY thread
        ...
        if (robot != null) {
            msGlobalPose = robot.getPoseEstimate();
        }
